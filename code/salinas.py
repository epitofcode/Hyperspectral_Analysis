"""
SALINAS - Complete Hyperspectral Classification Pipeline
========================================================
...
print("="*80)
print("SALINAS - COMPLETE CLASSIFICATION PIPELINE")
print("="*80)
print("\nThis script will:")
...
fig.suptitle('SALINAS - Complete Classification Results | ' +
...
dataset_text += f"Dataset: Salinas\n"
dataset_text += f"Location: Salinas Valley, CA\n"
dataset_text += f"Scene: Vegetation\n\n"
...
dataset_text += f"Resolution: 3.7m"
...
output_path = output_dir / 'SALINAS_COMPLETE.png'
...
with open(results_file, 'w') as f:
    f.write("SALINAS - COMPLETE CLASSIFICATION RESULTS\n")
    f.write("="*80 + "\n\n")
